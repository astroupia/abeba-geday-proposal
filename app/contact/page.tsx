                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Bole Road, Sunshine Building, 4th Floor</p>
                        <a
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">+251 911 789 012</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">support@sydek.com</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        <div className="container">
          ...
          <div className="mt-12 max-w-3xl mx-auto space-y-6">
            {[
              ...
              {
                question: "Do you provide training for our team to manage the website?",
                answer:
      ...
      <section className="py-20 bg-secondary text-secondary-foreground">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold">Ready to Start Your Digital Journey?</h2>
            <p className="text-secondary-foreground/80 text-lg">
              Let's collaborate to create a digital presence that elevates your brand and drives results.
            </p>
